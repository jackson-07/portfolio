        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              {showFullStory ? (
                <>
                  My journey from Technical Recruiting to Software Engineering has been an exciting adventure. 
                  As a recruiter, I developed a deep understanding of the tech industry and the skills that make an exceptional engineer. This insight drives my approach to coding and journey to becoming the best engineer I can be. 
                  <br /><br />
                  With an understanding of both the technical and human aspects of software development, I strive to create clean, effective and user-centred applications.
                </>
              ) : (
                '...'
              )}
